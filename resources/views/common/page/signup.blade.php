...
<div class="content-wrapper">
	...
	<div class="content-inner">
		...
		<div class="content d-flex justify-content-center align-items-center">
			...
			<!-- Login card -->
			<form class="login-form form-validate wmin-sm-400" action="{{route('signup-post')}}" method="post">
				{{ csrf_field() }}
				@if(count($errors)>0)
					...
					<div class="card-body">
						...
						<div class="form-group form-group-feedback form-group-feedback-left input-group">
							...
							<div class="input-group-append">
								<div class="input-group-text">
									<span class="ti-key">
										<div id="password2_eye" style="cursor: pointer;" onclick="show_pass('password2')"><i class="icon-eye-blocked2"></i></div>
										<div id="password2_eye_flash" style="display: none;cursor: pointer;" onclick="hidden_pass('password2')"><i class="icon-eye2"></i></div>
									</span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<a href="{{route('house')}}" class="btn btn-light btn-block">Về trang chủ</a>
						</div>
<!-- 
